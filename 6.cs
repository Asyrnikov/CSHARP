...
public class Program
{
	...
	{
	     Human p0 = new Human("Гореликов", 2003, "Студент");
	     Human p1 = new Human("Максимов", 2002, "Студент");
	     Human p2 = new Human("Гордон", 1991, "Преподаватель");
	     Human p3 = new Human("Филков", 2003, "Студент");
	     Human p4 = new Human("Ленцев", 1998, "Студент");
	     Human[] people = new Human[] {p0, p1, p2, p3, p4};
